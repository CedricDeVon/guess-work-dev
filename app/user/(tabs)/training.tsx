...
export default function UserTabsTraining() {
    const handleToBeSquareOnPress: Function = async () => {

    }

    const handleBlackOrWhiteOnPress: Function = async () => {

    }

    const handleToReachAPointOnPress: Function = async () => {

    }

    const handleTargetAquiredOnPress: Function = async () => {
